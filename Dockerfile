...
# expose port range for minecraft bedrock servers
EXPOSE 19132-19142

# expose port range for minecraft java servers
EXPOSE 25565-25575

# expose port for crafty web ui http (redirects to https)
EXPOSE 8000

# expose port for crafty web ui https
EXPOSE 8443
